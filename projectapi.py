...
import sys, json
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:\\Users\\HP\\Downloads\\key (1).json"

project_dir = "E:\Subjective-answer-evaluation-master"
...
def get_result():
    ...
    if files:
        ...
        marks = random.randint(1,int(request.form['max_marks']));
